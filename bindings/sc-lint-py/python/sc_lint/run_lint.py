...
from sc_lint.lint_common import write_log
...
def build_tasks(repo_root: Path) -> dict[str, LintTask]:
    ...
    return {
        ...
        "modules": LintTask("modules", [python_executable, "-m", "sc_lint.lint_cargo_modules"]),
        ...
        "identity-literals": LintTask(
            "identity-literals",
            [python_executable, "-m", "sc_lint.lint_identity_literals"],
        ),
        "manifests": LintTask("manifests", [python_executable, "-m", "sc_lint.lint_manifests"]),
        "spell": LintTask("spell", [python_executable, "-m", "sc_lint.lint_codespell"]),
        "pytests": LintTask("pytests", [python_executable, "-m", "sc_lint.run_pytests"]),
    }
