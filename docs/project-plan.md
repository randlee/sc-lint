...
- release 0.6.0 QA-3 gate (`lint-spx.28`)
  - see the dependent sprint records in `docs/plans/release-0.6.0/`
...
- phase execution plans
  ...
  - see [docs/plans/phase-A/sprint-A3.md](./plans/phase-A/sprint-A3.md)
  - see [docs/plans/phase-A/sprint-A4.md](./plans/phase-A/sprint-A4.md)
  - see [docs/plans/phase-A/sprint-A5.md](./plans/phase-A/sprint-A5.md)
  - see [docs/plans/phase-A/sprint-A6.md](./plans/phase-A/sprint-A6.md)
  - see [docs/plans/phase-A/sprint-A7.md](./plans/phase-A/sprint-A7.md)
  - see [docs/plans/phase-A/sprint-A8.md](./plans/phase-A/sprint-A8.md)
...
- `B.1`
  ...
  - explicit backlog planning for shared portability follow-ons in
    ...
    shell portability
  - `docs/plans/phase-B/sprint-B1.md`
- `B.2`
  - named-caller allowlist enforcement in `sc-lint-boundary`
  - `docs/plans/phase-B/sprint-B2.md`
- `B.3`
...
- `C.10`
  ...
  - retained-log policy enablement plus typestate, supported `emit(...)`
    ...
    logging seam
  - `docs/plans/phase-C/sprint-C10.md`
- `D.1`
