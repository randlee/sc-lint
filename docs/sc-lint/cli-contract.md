...
They select the release workflow's host archive
...
| `CLI.SC_LINT_POST_INSTALL_VERSION_FAILED` | The previous managed binary was restored; repair the release and rerun setup. |
