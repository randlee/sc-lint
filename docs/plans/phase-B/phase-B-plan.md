...
- `B.1`
  ...
  - see [docs/plans/phase-B/sprint-B1.md](./sprint-B1.md)
- `B.2`
  ...
  - see [docs/plans/phase-B/sprint-B2.md](./sprint-B2.md)
- `B.3`
  ...
  - see [docs/plans/phase-B/sprint-B3.md](./sprint-B3.md)
- `B.4`
  ...
  - see [docs/plans/phase-B/sprint-B4.md](./sprint-B4.md)
- `sprint-B-homebrew`
  ...
  - see [docs/plans/phase-B/sprint-B-homebrew.md](./sprint-B-homebrew.md)
